...
export const MOVE_FORWARD_PROJECT = 'MOVE_FORWARD_PROJECT'
export type MOVE_FORWARD_PROJECT = typeof MOVE_FORWARD_PROJECT

export const MOVE_BACKWARD_PROJECT = 'MOVE_BACKWARD_PROJECT'
export type MOVE_BACKWARD_PROJECT = typeof MOVE_BACKWARD_PROJECT